...
Если вам нужно синхронизировать конкретный пост, запустите приложение с параметром `-p <id поста>`. Можно указать автора через `-a <имя_автора>` или после программа спросит автора сама:
